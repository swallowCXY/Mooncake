...
// get_descriptor(), get_p2p_client_id(), operator<<(const Replica&) and
// operator<<(const Descriptor&) are defined in src/replica.cpp (they require
// the complete P2PClientMeta type for the P2P proxy case).
